...
function assembler(code){
      ...
      let instruction_tokens = ["HLT", "LDAD", "LDAM", "STAD", "PUSH", "POP", "ADD", "SUB", "MUL", "DIV", "MOD", "XOR", "OR", "AND", "LS", "RS", "EQ", "LT", "GT", "NE", "JMP", "JC", "JNC", "ADJM", "CALL", "RET", "IIPUSH", "IIPOP", "LDID", "LDIM", "STID", "LDIID", "LDIIM", "STIID", "LDIIA", "LDIA", "INP", "OUTP", "BPTOII","INCI","DECI","STIIA","STIA","IPUSH","IPOP","ADJP","SIIXAX","SIXAX"];
  ...
  for(i=0; i<tokens.length; i++){
      if(i+1 != tokens.length){
          if(tokens[i+1][0] != 0){
            ...
            //console.log(tokens);
			  console.log(Math.round((((internal_pc-entry_point)*32)/8)/1024) + "Kb",(internal_pc-entry_point)*32);
